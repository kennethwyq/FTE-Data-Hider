...
# Write data into the ads
def write_ads(data, file, stream_name):
    stream_path = f"{file}:{stream_name}"
    with open(stream_path, 'wb') as file_stream:
        file_stream.write(data)


# Read data from ads
def read_ads(file, stream_name):
    stream_path = f"{file}:{stream_name}"
    try:
...
# Function to delete an alternate data stream
def delete_ads(file, stream_name):
    stream_path = f"{file}:{stream_name}"
    try:
